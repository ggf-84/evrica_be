                ...
                <tr>
                    <td width="960">
                            ...
                            <tr>
                                <td width="960" bgcolor="#ffffff" style="border: 1px solid #e7eeee; border-radius: 5px;">
                                    ...
                                    <table width="960" border="0" cellpadding="0" cellspacing="0" align="center" style="margin-top: 40px;">
                                        <tr>
                                            <td width="960" style="padding-bottom: 40px; border-bottom: 1px solid #e7eeee;font-family: 'proxima_nova_softmedium', Helvetica, Arial, sans-serif;font-size: 39px;">
                                        <center>EvricaLab LOGO</center>
                                </td>
                            </tr>
                            <tr>
                        ...
                        <table width="960" border="0" cellpadding="0" cellspacing="0" align="center" style="margin-top: 60px; margin-bottom: 60px;">
                            ...
                            <tr>
                                <td width="40"></td>
                                <td  style="font-size: 16px; color: #686868; font-family: 'proxima_nova_softmedium', Helvetica, Arial, sans-serif; line-height: 24px;" valign="top">
                            ...
                            <tr>
                                <td width="40"></td>
                                <td style="font-size: 16px; color: #686868; text-align: center; font-family: 'proxima_nova_softmedium', Helvetica, Arial, sans-serif; line-height: 24px;" valign="top">

                                    <a href="#"  style="background-color: #65707a; font-family: 'proxima_nova_softmedium', Helvetica, Arial, sans-serif; text-decoration: none; color: #ffffff; padding: 10px 20px 10px 20px; border-radius: 4px; font-size: 18px;" class="hover">View Profile</a>
                                    <p style="margin-bottom: 5px;">
                                        <br/>
                                    </p>
                                    <a href="#"  style="background-color: #51c4d4; font-family: 'proxima_nova_softmedium', Helvetica, Arial, sans-serif; text-decoration: none; color: #ffffff; padding: 10px 20px 10px 20px; border-radius: 4px; font-size: 18px;" class="hover">View Settings</a>
                        ...
                        <table width="960" border="0" cellpadding="0" cellspacing="0" align="center" bgcolor="#65707a">
                            <tr>
                                <td height="100" style="font-size: 16px; color: #ffffff; text-align: right; font-family: 'proxima_nova_softregular', Helvetica, Arial, sans-serif; line-height: 24px; ">
                            <center>
                                {{isset($html['footer'])?$html['footer']:''}}
                            </center>
                    </td>
                </tr>
            </table>
