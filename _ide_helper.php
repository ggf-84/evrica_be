 ...
 * Generated for Laravel 5.4.36 on 2018-03-22 13:30:34.
 *
...
namespace App\Facades { 
    ...
    class UserHelper {
        ...
        {
            return \App\Http\Helpers\userHelper::get();
        }
        ...
        {
            return \App\Http\Helpers\userHelper::getUserById($id);
        }
        ...
        {
            return \App\Http\Helpers\userHelper::company();
        }
        ...
        {
            return \App\Http\Helpers\userHelper::checkCompany($userID, $companyID);
        }
        ...
        {
            return \App\Http\Helpers\userHelper::validateEnvToken($token);
        }
        ...
        {
            return \App\Http\Helpers\userHelper::validateAdminRules($token);
        }
        ...
        {
            return \App\Http\Helpers\userHelper::admin();
        }
        ...
        public static function token()
        {
            return \App\Http\Helpers\userHelper::token();
        }
        ...
        {
            return \App\Http\Helpers\userHelper::userCompany();
        }
        ...
        {
            return \App\Http\Helpers\userHelper::getHeaderToken($headType);
        }
        ...
        {
            return \App\Http\Helpers\userHelper::isAdmin();
        }
        ...
        {
            return \App\Http\Helpers\userHelper::validateEnvException();
        }
         ...
         * @static 
         */ 
        public static function originalToken()
        {
            return \App\Http\Helpers\userHelper::originalToken();
        }
    ...
    class LangHelper {
         ...
         *
         * @return \App\Http\Helpers\App\Models\Langauge $language
         * @static 
         */ 
        public static function get()
        {
            return \App\Http\Helpers\i18nHelper::get();
        }
        
        /**
         * Get list of languages for company
         *
         * @return \App\Http\Helpers\App\Models\CompanyLangauge $list
         * @static 
         */ 
        public static function company()
        {
            return \App\Http\Helpers\i18nHelper::company();
        }
        
        /**
         * Get langauge object by code
         * return App\Models\Language $languages
         *
         * @static 
         */ 
        public static function byCode($code)
        {
            return \App\Http\Helpers\i18nHelper::byCode($code);
        }
        ...
        {
            return \App\Http\Helpers\i18nHelper::byId($id);
        }
        
        /**
         * Get default language for current company
         *
        ...
        {
            return \App\Http\Helpers\i18nHelper::defaultLanguage();
        }
        
        /**
         * Get current language as object
         *
         * @return \App\Http\Helpers\App\Models\Language; 
         * @static 
         */ 
        public static function currentLanguage()
        {
            return \App\Http\Helpers\i18nHelper::currentLanguage();
        }
        
        /**
         * Detect requested language from request header (Accept-Language:ru;q=1,en;q=0.8)
         * return string language code (en,ru,ro,de,it)
         *
         * @static 
         */ 
        public static function requestLanguage()
        {
            return \App\Http\Helpers\i18nHelper::requestLanguage();
        }
        
        /**
         * Generate translated template
         *
         * @param mixed $template template (string or collection or array) with translatable variables example: {!!variable!!}
         * @param int $lang language_id
         * @return mixed $template
         * @static 
         */ 
        public static function translateTemplate($template, $lang = null)
        {
            return \App\Http\Helpers\i18nHelper::translateTemplate($template, $lang);
        }
        
        /**
         * Translate variable by key
         *
         * @param \App\Http\Helpers\type $key
         * @param integer $lang
         * @static 
         */ 
        public static function translateByKey($key, $lang = null)
        {
            return \App\Http\Helpers\i18nHelper::translateByKey($key, $lang);
        }
        
        /**
         * Translate fields
         *
         * @param \Illuminate\Database\Eloquent\Model $model return mixed $terms
         * @static 
         */ 
        public static function translateFields($model)
        {
            return \App\Http\Helpers\i18nHelper::translateFields($model);
        }
    ...
    class SettingsHelper {
        ...
        /**
         * Get setting for current user by code
         *
         * @static 
         */ 
        public static function get($code)
        {
            return \App\Http\Helpers\settingsHelper::get($code);
        }
        ...
        {
            return \App\Http\Helpers\settingsHelper::set($code, $value);
        }
        
        /**
         * Get setting by code for current company
         *
         * @param string  code
         * @return array $setting setting with value and code
         * @static 
         */ 
        public static function companyGet($code)
        {
            return \App\Http\Helpers\settingsHelper::companyGet($code);
        }
        
        /**
         * Set value for setting by code
         *
         * @param array $setting setting with code and value
         * @return array setting
         * @static 
         */ 
        public static function companySet($code, $value)
        {
            return \App\Http\Helpers\settingsHelper::companySet($code, $value);
        }
        
        /**
         * Get system setting
         *
         * @param string $code return string value for setting
         * @static 
         */ 
        public static function getSystem($code)
        {
            return \App\Http\Helpers\settingsHelper::getSystem($code);
        }
        
        /**
         * Set default setting for system
         *
         * @param string $code
         * @param string $value
         * @return \App\Models\SystemSettings system setting
         * @static 
         */ 
        public static function setSystem($code, $value)
        {
            return \App\Http\Helpers\settingsHelper::setSystem($code, $value);
        }
        
        /**
         * Get setting_value by company_id and code
         *
         * @param int $company_id
         * @param string $code return mixed
         * @static 
         */ 
        public static function getSettingValByCompany($company_id, $code)
        {
            return \App\Http\Helpers\settingsHelper::getSettingValByCompany($company_id, $code);
        }
    ...
    class PermissionHelper {
        ...
        /**
         * Check if current user have permission to specific action
         *
         * @param string $code
         * @return boolean 
         * @static 
         */ 
        public static function can($code, $user = null)
        {
            return \App\Http\Helpers\permissionHelper::can($code, $user);
        }
         ...
         * @static 
         */ 
        public static function getAvailablePermissions($user = null)
        {
            return \App\Http\Helpers\permissionHelper::getAvailablePermissions($user);
        }
         ...
         * @static 
         */ 
        public static function storeDomainRecord($data, $company_id)
        {
            return \App\Http\Helpers\permissionHelper::storeDomainRecord($data, $company_id);
        }
        
        /**
         * Get correct last url ending in domain, base domain , server name , ip and content for powerDNS
         *
         * @static 
         */ 
        public static function serverPdns()
        {
            return \App\Http\Helpers\permissionHelper::serverPdns();
        }
        
        /**
         * Detect base host and content
         *
         * @param $currentServerName
         * @param $urlEndings
         * @param $detectedBaseDomain
         * @static 
         */ 
        public static function detectHost($currentServerName, $urlEndings, $detectedBaseDomain)
        {
            return \App\Http\Helpers\permissionHelper::detectHost($currentServerName, $urlEndings, $detectedBaseDomain);
        }
        
        /**
         * Get domain records for company
         *
         * @param $id
         * @static 
         */ 
        public static function getDomainRecords($id)
        {
            return \App\Http\Helpers\permissionHelper::getDomainRecords($id);
        }
        
        /**
         * Update domain records (pdns and database)
         *
         * @param $id
         * @param $request
         * @static 
         */ 
        public static function putDomainRecords($request, $id)
        {
            return \App\Http\Helpers\permissionHelper::putDomainRecords($request, $id);
        }
        
        /**
         * Delete domain records (pdns and database)
         *
         * @param $request
         * @static 
         */ 
        public static function deleteDomainRecords($request)
        {
            return \App\Http\Helpers\permissionHelper::deleteDomainRecords($request);
        }
        
        /**
         * Validate if company exists and can delete domain record
         * this validation is an extra layer for data check
         *
         * @param $request
         * @param $fullDomain
         * @param $detectBaseDomain
         * @param $content
         * @static 
         */ 
        public static function validateDeleteRecord($request, $fullDomain, $detectedBaseDomain, $content)
        {
            return \App\Http\Helpers\permissionHelper::validateDeleteRecord($request, $fullDomain, $detectedBaseDomain, $content);
        }
        
        /**
         * Add new domain records for company (pdns and database)
         *
         * @param $request
         * @static 
         */ 
        public static function postDomainRecords($request)
        {
            return \App\Http\Helpers\permissionHelper::postDomainRecords($request);
        }
        
        /**
         * Validate if company exists and can modify domain record
         * this validation is an extra layer for data check
         *
         * @param $request
         * @param $fullDomain
         ...
         * @static 
         */ 
        public static function validateRecord($request, $fullDomain, $fullDomainNd, $detectedBaseDomain, $content)
        {
            return \App\Http\Helpers\permissionHelper::validateRecord($request, $fullDomain, $fullDomainNd, $detectedBaseDomain, $content);
        }
        
        /**
         * Validate if company can create a new domain record
         * this validation is an extra layer for data check
         * this validation adds record to pdns and database
         *
         * @param $request
         * @param $fullDomain
         * @param $detectBaseDomain
         ...
         * @static 
         */ 
        public static function validatePostRecord($request, $fullDomain, $detectedBaseDomain, $content)
        {
            return \App\Http\Helpers\permissionHelper::validatePostRecord($request, $fullDomain, $detectedBaseDomain, $content);
        }
        ...
        public static function getHeaderToken($headType)
        {
            return \App\Http\Helpers\permissionHelper::getHeaderToken($headType);
        }
         ...
         * @static 
         */ 
        public static function getHeader($headType)
        {
            return \App\Http\Helpers\permissionHelper::getHeader($headType);
        }
    ...
    class WsHelper {
        ...
        /**
         * Send message to recipient using RabbitMQ & NodeJS server
         *
         * @param mixed $data data for message
         * @param string $conn connection id
         * @param string $event event type, default=output
         * @return mixed $status
         * @static 
         */ 
        public static function send($data = array(), $conn = array(), $event = 'output')
        {
            return \App\Http\Helpers\wsHelper::send($data, $conn, $event);
        }
        
        /**
         * Check if connection exist (by User or by connection)
         *
         * @param int $user
         * @param string $conn
         ...
         * @static 
         */ 
        public static function check($user = 0, $conn = null)
        {
            return \App\Http\Helpers\wsHelper::check($user, $conn);
        }
        
        /**
         * Get user by connection
         *
         * @param string $conn return App\Models\WsConnections
         * @static 
         */ 
        public static function get($conn)
        {
            return \App\Http\Helpers\wsHelper::get($conn);
        }
         ...
         * @static 
         */ 
        public static function connection($user = 0)
        {
            return \App\Http\Helpers\wsHelper::connection($user);
        }
         ...
         * @static 
         */ 
        public static function user($user = 0)
        {
            return \App\Http\Helpers\wsHelper::user($user);
        }
        
        /**
         * Check if socket connection and user id exists
         *
         * @param $userID
         * @param $conn
         * @static 
         */ 
        public static function exists($userID, $conn)
        {
            return \App\Http\Helpers\wsHelper::exists($userID, $conn);
        }
         ...
         * @static 
         */ 
        public static function listConnections($companyID, $userID)
        {
            return \App\Http\Helpers\wsHelper::listConnections($companyID, $userID);
        }
...
namespace Vinelab\Bowler\Facades { 
    ...
    class Registrator {
         ...
         * @static 
         */ 
        public static function queue($queue, $className, $options = array())
        {
            return \Vinelab\Bowler\RegisterQueues::queue($queue, $className, $options);
        }
         ...
         * @static 
         */ 
        public static function subscriber($queue, $className, $bindingKeys)
        {
            return \Vinelab\Bowler\RegisterQueues::subscriber($queue, $className, $bindingKeys);
        }
        ...
        {
            return \Vinelab\Bowler\RegisterQueues::getHandlers();
        }
...
namespace  { 
    ...
    class UserHelper extends \App\Facades\UserHelper {}

    class LangHelper extends \App\Facades\LangHelper {}

    class SettingsHelper extends \App\Facades\SettingsHelper {}

    class PermissionHelper extends \App\Facades\PermissionHelper {}

    class WsHelper extends \App\Facades\WsHelper {}

    class Registrator extends \Vinelab\Bowler\Facades\Registrator {}

    class Socialite extends \Laravel\Socialite\Facades\Socialite {}

    class TaxHelper extends \App\Http\Helpers\taxHelper {}

    class ImportHelper extends \App\Http\Helpers\importHelper {}

    class Countries extends \PragmaRX\Countries\Facade {}

    class ChatHelper extends \App\Http\Helpers\chatHelper {}
